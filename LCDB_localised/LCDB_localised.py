...
# write dic to file
with open('openmlid_learner.txt', 'w') as f:
    f.write(str(openmlid_learner))

# read from file
with open(path + '/openmlid_learner.txt', 'r') as f:
...
df = pd.read_pickle('all_curves_preprocessed.pkl')
...
print(test.info())
#save the data
train.to_pickle('train_curves.pkl')
test.to_pickle('test_curves.pkl')
